...
class Character(models.Model):
    actors = models.ManyToManyField('Actor', blank=True, related_query_name='character', db_table='character_actor_relation')
    books = models.ManyToManyField('Book', blank=True, related_query_name='character', db_table='character_book_relation')
